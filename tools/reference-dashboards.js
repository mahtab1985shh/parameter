(function(){
  ...
  window.renderDashboard=function(){
    ...
    root.classList.toggle('reference-dashboard-active',modes.indexOf(dashboardMode)>=0);
    if(modes.indexOf(dashboardMode)<0){oldRender();return}
    ...
    var mode=dashboardMode,frame=frames[mode];
